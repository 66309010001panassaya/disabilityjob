...
<body>
    ...
    $_SESSION['index'] = 1;
         ...
         $sqlu="UPDATE mail set m_status='1' where m_uid='$id'";
    ...
    ?>
	 ...
	 <div class="col-sm-12 col-md-9 col-lg-9 mx-auto">
        <div class="card mx-auto">
         ...
         $sql="SELECT * from mail,company where m_uid='$id' and m_cpid=cp_id  ";
            $result=mysqli_query($con,$sql);
            $num=mysqli_num_rows($result);
         ?>
          <div class="card-body " >
            <h5 class="card-title">ข้อความ  </h5>
                ...
                <tr >
                    ...
                    <td>
                        <p>
                            ...
                            <?php echo "ข้อความ : ".$row['m_text']; ?><br>
